...
export default class AccountProfile extends React.Component {
    ...
    updateAndSaveData(newValues) {
        let newProfile = Object.assign({}, this.state.profileData, newValues);
        // console.log("updateAndSaveData -- newValues: " + JSON.stringify(newProfile))
        this.setState({
            profileData: newProfile
        }, this.saveProfile)
    }
    ...
    saveProfile() {
        ...
        $.ajax({
            ...
            success: function (res) {
               ...
               //     this.loadData();     // Get the latest data... - Added Line...
                    // console.log("New Data from Database: " + JSON.stringify(res.data))
                } else {
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <SocialMediaLinkedAccount
                                                ...
                                                componentId='socialMediaLinkedAccounts'
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='User Details'
                                        ...
                                        >
                                            <Nationality
                                                ...
                                                saveProfileData={this.updateAndSaveData}
                                                updateProfileData={this.updateWithoutSave}
                                                componentId='nationalityDetails'
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Languages'
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                imgName={this.state.profileData.profilePhoto}
                                               // updateProfileData={this.updateWithoutSave}
                                               // saveProfileData={this.updateAndSaveData}
                                        ...
                                        <FormItemWrapper
                                            title='Description'
                                            tooltip='Write a description about your self.'
                                            hideSegment={true}
                                        >
                                        <SelfIntroduction
